...
import MyCv from '/public/Youssef_Eissa.pdf'
...
<div ref={ref} className='row d-flex  align-items-center home'>
        <motion.div
            ...
            <div className='col-12 my-5 justify-content-center d-flex'>
                <Link className='rounded link text-center col-md-3 col-6 py-3 px-2' target='_blank' to={`/YoussefPortfolio/${MyCv}`} download='Youssef_Eissa.pdf' >Download My CV</Link>
            </div>
            </motion.div>
            <motion.div
            animate={animation2}
