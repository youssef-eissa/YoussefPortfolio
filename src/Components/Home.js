...
<div ref={ref} className='row d-flex  align-items-center home'>
        <motion.div
            ...
            <div className='col-12 my-5 justify-content-center d-flex'>
                <Link className='rounded link text-center col-md-3 col-6 py-3 px-2' target='_blank' to='https://youssef-eissa.github.io/YoussefPortfolio/Youssef_eissa.pdf' download='Youssef_Eissa.pdf' >Download My CV</Link>
            </div>
            </motion.div>
            <motion.div
            animate={animation2}
